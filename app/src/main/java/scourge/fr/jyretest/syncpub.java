...
*/
public class syncpub implements Runnable {
    /**
     * We wait for 10 subscribers
     */
    protected static int SUBSCRIBERS_EXPECTED;

    public syncpub(MainActivity mainActivity) {

        SUBSCRIBERS_EXPECTED =  mainActivity.getNUMBER_SUB();
    }
    ...
    public void run() {
        ...
        //  Now broadcast exactly 1M updates followed by END
         Log.i("PUB", "Broadcasting messages");
