...
public class ZreTester implements Runnable
{
    ...
    public void run() {
        ...
        while (!Thread.currentThread ().isInterrupted ()) {
            ...
            if (pipes [index] != null) {
                ...
                pipes [index] = null;
                Log.i("ZreTester", "Stopped interface (" + --nbr_interfaces + " running)\n");
            }
            else {
                pipes [index] = ZThread.fork (ctx, new InterfaceTask ());
                Log.i("ZreTester", "Started interface (" + ++nbr_interfaces + " running)\n");
            }
        ...
        Log.i("ZreTester", "Stopped tester ("+nbr_tries+" tries)\n");
        ctx.destroy ();
    }
